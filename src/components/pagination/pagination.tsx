    ...
    <div className="pagination page-content__pagination">
      ...
      <li className='pagination__page pagination__page--next'>
        <Link className="link pagination__page-link"
          to={`${generatePath(AppRoute.Catalog, {pageNumber: `${prevPage}`})}${window.location.search}`}
      ...
      </li>}
        {
          numbersPage.map((number) => (
            ...
            >
              <Link className="link pagination__page-link"
                to={`${generatePath(AppRoute.Catalog, {pageNumber: `${number}`})}${window.location.search}`}
        ...
        <li className='pagination__page pagination__page--next'>
          <Link className="link pagination__page-link"
            to={`${generatePath(AppRoute.Catalog, {pageNumber: `${nextPage}`})}${window.location.search}`}
